...
export default function PrivacyPolicyPage() {
  return (
    <>
      <Head>
        <title>Privacy Policy - Eviratec Social Platform</title>
        <meta name="description" content="Eviratec Social Platform Privacy Policy" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href="/favicon.ico" />
        <meta name="theme-color" content="rgba(170, 68, 33)" />
        <meta property="og:title" content="Eviratec Social Platform Privacy Policy" />
        <meta property="og:description" content="Eviratec Social Platform Privacy Policy" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.eviratecsocial.com/privacy" />
      ...
      <main className={styles.main}>
        ...
        <section className={styles.legal}>
          ...
          <p>If you have any questions about this Privacy Policy, please contact us via email: <Link href="mailto:legal@eviratec.com">legal@eviratec.com</Link>.</p>
        </section>
      </main>
